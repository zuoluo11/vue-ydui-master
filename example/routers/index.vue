<template>
    <yd-layout>
        ...
        <yd-grids-group rows="4">
            <yd-grids-item v-for="item in myList" :link="item.link">
...
export default {
  data() {
    return {
      myList: [
        { icon: "home", name: "首页", link: "/myindex" },
        { icon: "checkoff", name: "今日", link: "/todayalarm" },
        { icon: "compose", name: "全部", link: "/allalarm" },
        { icon: "setting", name: "新增", link: "/add" }
      ],
      list: [
