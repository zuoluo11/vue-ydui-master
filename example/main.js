...
import MyIndex from './routers/pages/myindex.vue'
import Add from './routers/pages/add.vue'
import AllAlarm from './routers/pages/allalarm.vue'
import TodayAlarm from './routers/pages/todayalarm.vue'
...
const router = new VueRouter({
    routes: [
        ...
        {path: '/myindex', name: 'myindex', component: MyIndex},//自定义
        {path: '/add', name: 'add', component: Add},
        {path: '/allalarm', name: 'allalarm', component: AllAlarm},
        {path: '/todayalarm', name: 'todayalarm', component: TodayAlarm},
